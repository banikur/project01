...
<div class="bg">
    <div class="limiter">
        <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50" style="float: right; margin: 3%">
            ...
            <form class="login100-form validate-form" method="POST" action="{{ route('login') }}">
                ...
                @csrf
                    ...
                    <h3><center>LOGIN</center></h3>
                        <img src="front_login/images/logo_kemenkeu.png" />
                    </span>
                    <h5><center>Applikasi SiPerda</center></h5><br/>
                ...
                <div style="text-align: center">
                    <span style="font-weight: bold; color: red">User tidak terdaftar silakan mendaftar di <a href="http://ems.minerba.go.id/">EMS Minerba</a></span>
                </div>
                @endif
